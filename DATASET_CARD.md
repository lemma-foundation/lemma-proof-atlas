...
The checked-in artifact set contains 344 accepted Lean proof rows, pinned registries used to select active K-windows, one proof-erased Mathlib snapshot, and compact JSONL exports for downstream inspection.
